...
template <typename dataType> class const_iterator
{
   ...
   public:
      ...
      const_iterator(const bintree<dataType> *myParent) : parent(myParent)
      {
         ...
         // morseNode with lowest value in tree
         current = parent->root;
      ...
      const_iterator<dataType> operator ++ ()
      {
         ...
         if (current->right != NULL)
         {
            ...
            // move down to smallest morseNode in that branch
         ...
         else
         {
            ...
            const dataType *currentData = &(current->morseNodeData);
            do
            {
               current = current->root;
            } while (current != NULL && current->morseNodeData < *currentData);
         }
         return *this;
      }
      ...
      const_iterator<dataType> operator -- ()
      {
         ...
         if (current->left != NULL)
         {
            ...
            // move down to largest morseNode in that branch
         ...
         else
         {
            ...
            dataType *currentData = &(current->morseNodeData);
            do
            {
               current = current->root;
            } while (current != NULL && current->morseNodeData > *currentData);
